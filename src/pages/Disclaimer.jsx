...
const Disclaimer = () => {
  return (
    <div className='lg:px-32 md:px-12 sm:px-5 px-3  lg:py-8 py-4'>
      <h1
        className=' font-semibold sm:text-3xl text-2xl  inline-block px-2 border-b-[#af7501] mb-3 py-1 border-b-2 text-[#0f5f17]'>
        Diclaimer
      </h1>
      <p className='pt-1 md:text-lg'>
        ...
        including without limitation, reproduction, distribution, modification, adaptation
        and republication without the written permission of APEDA is expressly prohibited.
      </p>

      <p className='md:text-lg my-2 md:my-4'>
        Unauthorized use of documents, images, software and other proprietary material on this Site may violate copyright,
        trademark, privacy, right to publicity, export and communications laws and regulations of any country.
      </p>
      ...
      <p className='md:text-lg my-2 md:my-4'>
        ...
        The data referenced in the system do not have any legal sanctity and is for general reference only.The user may like to verify official publications for DGCI&S, Kolkata for any further reference.
      </p>

      <p className='md:text-lg my-2 md:my-4'>
        Contents of this web site are subject to change from time to time. All efforts are made to keep the site up to
        date, but at no given time can we guarantee the information to be up to date. For any further clarifications, amendments, etc, kindly contact to the office.
      </p>
